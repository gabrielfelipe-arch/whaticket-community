  ...
  en: {
    translations: {
      ...
      transferTicketModal: {
        ...
        noOnlineUsers: "No online attendant found",
        noOnlineUsersInQueue: "No online attendant in this queue",
        onlineOnly: "Transfers to attendants can only be made to online users.",
        selectTarget: "Select a queue or an online attendant.",
        onlineLabel: "Online",
        awayLabel: "Away",
      ...
      backendErrors: {
        ...
        "Internal server error":
          "Internal system error. Try again or contact support.",
        ERR_CLOSING_FIELDS_REQUIRED:
          "Select a category and a closing reason before resolving the ticket.",
        ERR_CLOSING_REASON_REQUIRED:
          "Select a closing reason before resolving the ticket.",
        ERR_FETCH_WAPP_MSG:
